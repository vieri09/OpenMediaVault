...
describe('key determinism', () => {
  ...
  it('groups albums case/space-insensitively', () => {
    expect(albumKey('Discovery', 'Daft Punk')).toBe(albumKey(' discovery ', '  daft punk'));
  });
  it('treats unknown album/artist consistently', () => {
